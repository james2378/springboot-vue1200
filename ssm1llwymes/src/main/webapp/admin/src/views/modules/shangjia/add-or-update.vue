	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="upload" v-if="type!='info' && !ro.shangjiatupian" label="宠物店图片" prop="shangjiatupian">
					<file-upload
						tip="点击上传宠物店图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="upload" v-else-if="ruleForm.shangjiatupian" label="宠物店图片" prop="shangjiatupian">
...
export default {
	data() {
		...
		return {
			...
			rules: {
				shangjiamingcheng: [
					{ required: true, message: '宠物店名称不能为空', trigger: 'blur' },
				],
				mima: [
					{ required: true, message: '密码不能为空', trigger: 'blur' },
				],
				shangjiatupian: [
					{ required: true, message: '宠物店图片不能为空', trigger: 'blur' },
				],
				lianxiren: [
				],
				lianxidianhua: [
