<template>
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="品种" prop="pinpai">
					<el-input v-model="ruleForm.pinpai" placeholder="品种" clearable  :readonly="ro.pinpai"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="品种" prop="pinpai">
					<el-input v-model="ruleForm.pinpai" placeholder="品种" readonly></el-input>
				</el-form-item>
			</template>
