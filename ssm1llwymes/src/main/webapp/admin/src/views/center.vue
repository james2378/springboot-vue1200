  ...
  <div :style='{"color":"#666","padding":"20px 30px 30px","fontSize":"14px"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}'   v-if="flag=='shangjia'"  label="宠物店名称" prop="shangjiamingcheng">
          <el-input v-model="ruleForm.shangjiamingcheng" readonly              placeholder="宠物店名称" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-if="flag=='shangjia'" label="宠物店图片" prop="shangjiatupian">
          <file-upload
          tip="点击上传宠物店图片"
          action="file/upload"
          :limit="3"
        ...
        <el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}'   v-if="flag=='shangjia'"  label="宠物店地址" prop="shangjiadizhi">
          <el-input v-model="ruleForm.shangjiadizhi"               placeholder="宠物店地址" clearable></el-input>
        </el-form-item>
