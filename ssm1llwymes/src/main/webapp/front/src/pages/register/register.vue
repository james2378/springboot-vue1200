<template>
	...
	<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231121/4577495c378443ad95aab1ad5fe253e2.png)","display":"flex","width":"100%","backgroundSize":"100% 100%","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"flex-end"}'>
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"padding":"20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3)","margin":"0 100px","borderRadius":"0","background":"#fff","width":"40%","height":"auto"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="true" :style='{"margin":"0 auto 20px","color":"#000","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"22px","textShadow":"none","fontWeight":"500"}'>基于ssm的宠物店管理系统注册</p></div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='shangjia'" prop="shangjiamingcheng">
				<div v-if="true" :style='{"width":"120px","padding":"0 5px 0 0","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center"}' :class="changeRules('shangjiamingcheng')?'required':''">宠物店名称：</div>
				<el-input v-model="registerForm.shangjiamingcheng"  placeholder="请输入宠物店名称" />
			</el-form-item>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='shangjia'" prop="shangjiatupian">
				<div v-if="true" :style='{"width":"120px","padding":"0 5px 0 0","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center"}' :class="changeRules('shangjiatupian')?'required':''">宠物店图片：</div>
                <file-upload
					tip="点击上传宠物店图片"
					action="file/upload"
					:limit="1"
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='shangjia'" prop="shangjiadizhi">
				<div v-if="true" :style='{"width":"120px","padding":"0 5px 0 0","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center"}' :class="changeRules('shangjiadizhi')?'required':''">宠物店地址：</div>
				<el-input v-model="registerForm.shangjiadizhi"  placeholder="请输入宠物店地址" />
			</el-form-item>
	...
	mounted() {
		if(this.$route.query.pageFlag=='register'){
			...
			if ('shangjia' == this.tableName) {
				this.requiredRules.shangjiamingcheng = [{ required: true, message: '请输入宠物店名称', trigger: 'blur' }]
			}
			if ('shangjia' == this.tableName) {
				this.requiredRules.mima = [{ required: true, message: '请输入密码', trigger: 'blur' }]
			}
			if ('shangjia' == this.tableName) {
				this.requiredRules.shangjiatupian = [{ required: true, message: '请输入宠物店图片', trigger: 'blur' }]
			}
		}
	},
    created() {
